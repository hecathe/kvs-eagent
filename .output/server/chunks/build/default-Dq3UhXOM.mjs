...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_nuxt_link = __nuxt_component_0$1;
  _push(`<ul${ssrRenderAttrs(mergeProps({ class: "header-menu-main" }, _attrs))} data-v-59680a79><!--[-->`);
  ssrRenderList($props.list, (item, index) => {
    _push(`<li class="header-menu-main__item" data-v-59680a79>`);
    _push(ssrRenderComponent(_component_nuxt_link, {
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$5], ["__scopeId", "data-v-59680a79"]]);
const _sfc_main$4 = {
  props: {
    list: {
      type: Array,
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<header${ssrRenderAttrs(mergeProps({ class: "header" }, _attrs))} data-v-aaf19a50>`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    class: "header__logo",
    to: "/"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", $props.template.kvs_logo)} alt="" data-v-aaf19a50${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
  ...
  _push(`<div class="header__mobile-wrap" data-v-aaf19a50>`);
  _push(ssrRenderComponent(_component_AppHeaderUser, {
    user: $props.template.user
  }, null, _parent));
  _push(`<button class="${ssrRenderClass([{ open: $data.opened }, "header__burger"])}" data-v-aaf19a50><span data-v-aaf19a50></span></button></div>`);
  if ($data.opened) {
    _push(`<div class="header__mobile-menu" data-v-aaf19a50>`);
    ...
    _push(`<div class="header__mobile-lists" data-v-aaf19a50>`);
  ...
  _push(`<div class="header__top" data-v-aaf19a50><div class="header__wrapper" data-v-aaf19a50>`);
  _push(ssrRenderComponent(_component_AppHeaderMenuTop, {
    list: $props.template.menu_top
  }, null, _parent));
  _push(ssrRenderComponent(_component_Slogan, null, null, _parent));
  _push(`</div></div><div class="header__bottom" data-v-aaf19a50><div class="header__wrapper" data-v-aaf19a50>`);
  _push(ssrRenderComponent(_component_AppHeaderMenuMain, {
    list: $props.template.menu_bottom
  }, null, _parent));
  _push(`<div class="header__user-wrap" data-v-aaf19a50><img class="header__eagent"${ssrRenderAttr("src", $props.template.eagent_logo)} alt="" data-v-aaf19a50>`);
  _push(ssrRenderComponent(_component_AppHeaderUser, {
    user: $props.template.user
  }, null, _parent));
  _push(ssrRenderComponent(_component_AppHeaderUserActions, null, null, _parent));
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-aaf19a50"]]);
const _sfc_main$2 = {
  props: {
    socials: {
      type: Array,
...
//# sourceMappingURL=default-Dq3UhXOM.mjs.map
