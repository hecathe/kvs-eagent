...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<header${ssrRenderAttrs(mergeProps({ class: "header" }, _attrs))} data-v-ba2949eb>`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    class: "header__logo",
    to: "/"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", $data.kvs_logo.url)} alt="" data-v-ba2949eb${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
  ...
  _push(`<div class="header__mobile-wrap" data-v-ba2949eb>`);
  _push(ssrRenderComponent(_component_AppHeaderUser, { user: $data.user }, null, _parent));
  _push(`<button class="${ssrRenderClass([{ open: $data.opened }, "header__burger"])}" data-v-ba2949eb><span data-v-ba2949eb></span></button></div>`);
  if ($data.opened) {
    _push(`<div class="header__mobile-menu" data-v-ba2949eb>`);
    ...
    _push(`<div class="header__mobile-lists" data-v-ba2949eb>`);
  ...
  _push(`<div class="header__top" data-v-ba2949eb><div class="header__wrapper" data-v-ba2949eb>`);
  _push(ssrRenderComponent(_component_AppHeaderMenuTop, { list: $data.menu_top }, null, _parent));
  _push(ssrRenderComponent(_component_Slogan, null, null, _parent));
  _push(`</div></div><div class="header__bottom" data-v-ba2949eb><div class="header__wrapper" data-v-ba2949eb>`);
  _push(ssrRenderComponent(_component_AppHeaderMenuMain, { list: $data.menu_bottom }, null, _parent));
  _push(`<div class="header__user-wrap" data-v-ba2949eb><img class="header__eagent"${ssrRenderAttr("src", $data.eagent_logo.url)} alt="" data-v-ba2949eb>`);
  _push(ssrRenderComponent(_component_AppHeaderUser, { user: $data.user }, null, _parent));
  _push(ssrRenderComponent(_component_AppHeaderUserActions, null, null, _parent));
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-ba2949eb"]]);
const _sfc_main$2 = {
  props: {
    socials: {
      type: Array,
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "footer" }, _attrs))} data-v-6c4b01d4><div class="container" data-v-6c4b01d4><div class="footer__item" data-v-6c4b01d4>2020, \u0413\u0440\u0443\u043F\u043F\u0430 \u043A\u043E\u043C\u043F\u0430\u043D\u0438\u0439 \xAB\u041A\u0412\u0421\xBB</div><div class="footer__item" data-v-6c4b01d4>`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    class: "footer__link",
    to: "#"
  }, {
  ...
  _push(`</div><div class="footer__item" data-v-6c4b01d4>`);
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-6c4b01d4"]]);
const _sfc_main = {};
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  const _component_AppHeader = __nuxt_component_0;
  const _component_AppFooter = __nuxt_component_1;
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "content" }, _attrs))} data-v-4d7c3de9>`);
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-4d7c3de9"]]);

export { _default as default };
//# sourceMappingURL=default-Cx0pWZsO.mjs.map
