import { _ as __nuxt_component_0$1 } from './nuxt-link-0SjH0J8j.mjs';
...
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_nuxt_link = __nuxt_component_0$1;
  _push(`<ul${ssrRenderAttrs(mergeProps({ class: "header-menu-main" }, _attrs))} data-v-e051038b><!--[-->`);
  ssrRenderList($props.list, (item, index) => {
    _push(`<li class="header-menu-main__item" data-v-e051038b>`);
    _push(ssrRenderComponent(_component_nuxt_link, {
...
const __nuxt_component_4 = /* @__PURE__ */ _export_sfc(_sfc_main$5, [["ssrRender", _sfc_ssrRender$5], ["__scopeId", "data-v-e051038b"]]);
const _sfc_main$4 = {
  props: {
    list: {
      type: Array,
...
function _sfc_ssrRender$3(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<header${ssrRenderAttrs(mergeProps({ class: "header" }, _attrs))} data-v-5a2798bd>`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    class: "header__logo",
    to: "/"
  }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", $props.template.kvs_logo)} alt="" data-v-5a2798bd${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            src: $props.template.kvs_logo,
            alt: ""
          }, null, 8, ["src"])
        ];
      }
  ...
  _push(`<div class="header__mobile-wrap" data-v-5a2798bd>`);
  _push(ssrRenderComponent(_component_AppHeaderUser, {
    user: $props.template.user
  }, null, _parent));
  _push(`<button class="${ssrRenderClass([{ open: _ctx.opened }, "header__burger"])}" data-v-5a2798bd><span data-v-5a2798bd></span></button></div>`);
  if (_ctx.opened) {
    _push(`<div class="header__mobile-menu" data-v-5a2798bd>`);
    ...
    _push(`<div class="header__mobile-lists" data-v-5a2798bd>`);
    _push(ssrRenderComponent(_component_AppHeaderMenuMain, {
      list: $props.template.menu_bottom
    }, null, _parent));
    _push(ssrRenderComponent(_component_AppHeaderMenuTop, {
      list: $props.template.menu_top
    }, null, _parent));
    _push(`</div></div>`);
  } else {
    _push(`<!---->`);
  }
  _push(`<div class="header__top" data-v-5a2798bd><div class="header__wrapper" data-v-5a2798bd>`);
  _push(ssrRenderComponent(_component_AppHeaderMenuTop, {
    list: $props.template.menu_top
  }, null, _parent));
  _push(ssrRenderComponent(_component_Slogan, null, null, _parent));
  _push(`</div></div><div class="header__bottom" data-v-5a2798bd><div class="header__wrapper" data-v-5a2798bd>`);
  _push(ssrRenderComponent(_component_AppHeaderMenuMain, {
    list: $props.template.menu_bottom
  }, null, _parent));
  _push(`<div class="header__user-wrap" data-v-5a2798bd><img class="header__eagent"${ssrRenderAttr("src", $props.template.eagent_logo)} alt="" data-v-5a2798bd>`);
  _push(ssrRenderComponent(_component_AppHeaderUser, {
    user: $props.template.user
  }, null, _parent));
  _push(ssrRenderComponent(_component_AppHeaderUserActions, null, null, _parent));
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["ssrRender", _sfc_ssrRender$3], ["__scopeId", "data-v-5a2798bd"]]);
const _sfc_main$2 = {
  props: {
    socials: {
      type: Array,
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<footer${ssrRenderAttrs(mergeProps({ class: "footer" }, _attrs))} data-v-8b7df758><div class="container" data-v-8b7df758><div class="footer__item" data-v-8b7df758>2020, \u0413\u0440\u0443\u043F\u043F\u0430 \u043A\u043E\u043C\u043F\u0430\u043D\u0438\u0439 \xAB\u041A\u0412\u0421\xBB</div><div class="footer__item" data-v-8b7df758>`);
  _push(ssrRenderComponent(_component_nuxt_link, {
    class: "footer__link",
    to: "#"
  }, {
  ...
  _push(`</div><div class="footer__item" data-v-8b7df758>`);
  _push(ssrRenderComponent(_component_SocialList, { socials: $props.social }, null, _parent));
...
const __nuxt_component_1 = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["ssrRender", _sfc_ssrRender$1], ["__scopeId", "data-v-8b7df758"]]);
const _sfc_main = {
  data() {
    return {
      template: {
        ...
        kvs_logo: "/kvs-eagent/icons/logo.svg",
        eagent_logo: "/kvs-eagent/icons/eagent.svg"
      },
      social: [
        {
          link: "#",
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<div${ssrRenderAttrs(mergeProps({ class: "content" }, _attrs))} data-v-c4f37bb3>`);
  _push(ssrRenderComponent(_component_AppHeader, { template: $data.template }, null, _parent));
  ssrRenderSlot(_ctx.$slots, "default", {}, null, _push, _parent);
  _push(ssrRenderComponent(_component_AppFooter, { social: $data.social }, null, _parent));
  _push(`</div>`);
}
...
const _default = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender], ["__scopeId", "data-v-c4f37bb3"]]);

export { _default as default };
//# sourceMappingURL=default-DhVq3-P5.mjs.map
