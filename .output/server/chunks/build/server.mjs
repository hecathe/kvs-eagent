...
const _routes = [
  {
    name: "clients",
    path: "/clients",
    component: () => import('./clients-I3Wircya.mjs').then((m) => m.default || m)
  },
  {
    name: "contacts",
    path: "/contacts",
    component: () => import('./contacts--9LZdY57.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
...
const layouts = {
  default: () => import('./default-Dq3UhXOM.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-9g8pbkVW.mjs').then((r) => r.default || r));
    const _Error = defineAsyncComponent(() => import('./error-500-Bq0l6sXz.mjs').then((r) => r.default || r));
